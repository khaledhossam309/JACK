...
redis:set(JACK.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(JACK..'lock:join:'..msg.chat_id_,true)
...
redis:del(JACK..'lock:join:'..msg.chat_id_)
return "*↯ أهلا عزيزي *"..msg.TheRankCmd.."*\n↯ تم فتح الدخول بالرابط \n*" 
end


local function iJACK(msg,MsgText)

Channel = redis:get(JACK..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(JACK..'joinchnl') then
...
redis:set(JACK.."getidstatus"..msg.chat_id_, "Photo")
redis:set(JACK..'lock:kara:'..msg.chat_id_,'off')
return modadd(msg)  
end
...
local GroupName = (redis:get(JACK..'group:name'..msg.chat_id_) or '')
redis:set(JACK..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(JACK..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "↯هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='..JACK..'')
...
function(arg,data)
if data.ID == "Ok" then
redis:set(JACK..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "↯هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(JACK..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(JACK..'lock:kara:'..msg.chat_id_) == 'on' then
...
if not msg.Director then return "↯هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(JACK..'linkGroup'..msg.sender_user_id_,300,true)
...
redis:set(JACK..'flood'..msg.chat_id_,MsgText[2]) 
...
local NumMnsha = redis:scard(JACK..':Hussain:'..msg.chat_id_)
redis:del(JACK..':Hussain:'..msg.chat_id_)
...
if not msg.Kara then return "✲¦ هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local NumMnsha = redis:scard(JACK..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "عذرا لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(JACK..':MONSHA_BOT:'..msg.chat_id_)
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(JACK..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(JACK..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(JACK..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(JACK..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
local points = redis:get(JACK..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(JACK..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if redis:get(JACK.."getidstatus"..msg.chat_id_) == "Photo" then
...
redis:del(JACK..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "↯تم مسح {* "..msgs.." *} من رسائلك .\n"
end

if MsgText[1]== 'جهاتي' then
return '↯  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(JACK..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(JACK..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "↯عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(JACK..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
redis:del(JACK..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(JACK..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(JACK..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(JACK..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(JACK..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(JACK..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(JACK..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(JACK..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(JACK..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(JACK..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[↯ اهلا انا بوت]]..redis:get(JACK..':NameBot:')..[[ .
...
return'↯⚶ شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(JACK..':addnumberusers')..'】* عضـو .\n' 
end 
end
...
if not msg.SudoUser then return "↯⚶هذا الامر يخص {المطور} فقط  \n" end
return '↯عدد المشتركين في البوت : `'..redis:scard(JACK..'users')..'` \n'
end
...
if not msg.SudoUser then return "↯⚶هذا الامر يخص {المطور} فقط  \n" end
if redis:sismember(JACK..'group:ids',MsgText[2]) then
local name_gp = redis:get(JACK..'group:name'..MsgText[2])
...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/abazaa/JACK.github.io/master/GetVersion.txt' ) or 0
...
return 'ٴ𐄬 اصدار سورس جاك و الجوكر: *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'↯⚶ عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس جاك و الجوكر يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/S_ADD_B_OYY"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : جاك](https://t.me/S_ADD_B_OYY)' ,nil,inline,msg.id_)
return false
end
...
if not msg.Admin then return "↯⚶هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n↯ " end
if not redis:get(JACK..'lave_me'..msg.chat_id_) then 
return "↯⚶أهلا عزيزي "..msg.TheRankCmd.."\n↯ المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(JACK..'lave_me'..msg.chat_id_) 
return "↯أهلا عزيزي "..msg.TheRankCmd.."\n↯ تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "↯⚶هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n↯ " end
if redis:get(JACK..'lave_me'..msg.chat_id_) then 
return "↯⚶أهلا عزيزي "..msg.TheRankCmd.."\n↯ المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(JACK..'lave_me'..msg.chat_id_,true)  
...
❀↯ -[DEVELOPER ②](t.me/A_j_o_k_e_r)

CHANNEL JACL 𖡛“](t.me/V_P_E) 

CHANNEL @V_P_E 𖡛“

TO TALK US 𖡨](t.me/J_A_C_K_7_BOT)
]]
end
...
return '↯⚶عدد سحكاتك ⇜ ❪ '..(redis:get(JACK..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'سحكاتي'  then
local rfih = (redis:get(JACK..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
if rfih == 0 then  return "↯ *│* لا يوجد سحكات لك في البوت ." end
redis:del(JACK..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
...
if redis:get(JACK..'welc'..msg.chat_id_) == 'on' then
...
local hash =JACK..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
mmd = redis:get(JACK..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(JACK..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(JACK..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'↯ اهلا عزيزي \n↯ تم تثبيت الامر الجديد\n✓')
redis:del(JACK..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if Black:match('تغير امر (.*)') then
if not msg.Kara then return "↯⚶هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(JACK..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(JACK..'CmD:'..msg.chat_id_,cmd)
redis:srem(JACK..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"↯⚶ اهلا عزيزي\nالامر >"..cmd.."\n↯ تم مسحه من قائمه الاوامر\n")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "↯⚶هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
redis:del(JACK..'CmD:'..msg.chat_id_)
redis:del(JACK..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"↯⚶ اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "↯⚶هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local CmDlist = redis:smembers(JACK..'CmDlist:'..msg.chat_id_)
local t = '↯ قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(JACK..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
redis:set(JACK..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(JACK..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(JACK..'welc'..msg.chat_id_,'off')
redis:del(JACK..'welc'..msg.chat_id_,'on')
else
...
function tophoto(kara,JACK)   
ifJACK.content_.ID == "MessageSticker" then        
local bd =JACK.content_.sticker_.sticker_.path_          
...
text = [[↯ أهلاً انا بوت   []]..redis:get(JACK..':NameBot:')..[[] 🗽
...
ــــــــــــــــــــــــــــــــJACKـــــــــــــــــــــــــ
...
local MSG_ID = (redis:get(JACK.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if msg.text then 
redis:hset(JACK..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
...
if msg.text then
redis:hset(JACK..'replay:all',klma,Flter_Markdown(msg.text))
...
elseif msg.voice then
redis:hset(JACK..'replay_voice:group:',klma,voice_id)
redis:del(JACK..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه بصمه صوت للرد العام\n↯ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(JACK..'replay_animation:group:',klma,animation_id)
redis:del(JACK..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه متحركه للرد العام\n↯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(JACK..'replay_video:group:',klma,video_id)
redis:del(JACK..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه فيديو للرد العام\n↯ يمكنك ارسال ❴ ['..klma..'] ❵لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(JACK..'replay_audio:group:',klma,audio_id)
redis:del(JACK..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'↯ تم اضافه للصوت للرد العام\n↯ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(JACK..'replay_sticker:group:',klma,sticker_id)
redis:del(JACK..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(JACK..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(JACK..'linkGroup'..msg.sender_user_id_,link) 
redis:set(JACK..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
...
if msg.adduser and msg.adduser == our_id and redis:get(JACK..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(JACK..':WELCOME_BOT'),[[↯أهلاً انا بوت ]]..redis:get(JACK..':NameBot:')..[[
↯ أختصاصي حماية‌‏ المجموعات
↯ مـن السبام والتوجيه‌‏ والتكرار والخ...
...
if msg.forward_info and redis:get(JACK..'fwd:'..msg.sender_user_id_) then
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(JACK..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(JACK..'welcome:msg'..msg.chat_id_) or "↯ اهلاً عزيزي {الاسم}\n↯ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n↯ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(JACK..'rulse:msg'..msg.chat_id_) or "↯ مرحباً عزيري القوانين كلاتي .\n↯ ممنوع نشر الروابط\n↯ ممنوع التكلم او نشر صور اباحيه\n↯ ممنوع  اعاده توجيه\n↯ ممنوع التكلم بالسياسة\n↯ الرجاء احترام المدراء والادمنيه .\n")
...
welcome = (redis:get(JACK..'welcome:msg'..msg.chat_id_) or "↯ اهلن بك عزيزي {الاسم}\n↯ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n↯ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(JACK..'rulse:msg'..msg.chat_id_) or "↯ مرحباً عزيري القوانين كلاتي .\n↯ ممنوع نشر الروابط\n↯ ممنوع التكلم او نشر صور اباحيه\n↯ ممنوع  اعاده توجيه\n↯ ممنوع التكلم بالسياسة\n↯ الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
--------------------------------------------
if msg.adduser and redis:get(JACK..'welcome:get'..msg.chat_id_) then
...
if not msg.forward_info and redis:get(JACK..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(JACK..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_JACK = (redis:get(JACK..'num_msg_JACK'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_JACK) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(JACK..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"↯ العضو » "..USERNAME.."\n↯ قمـت بتكرار اكثر مـن "..NUM_MSG_JACK.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(JACK..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(JACK..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(JACK..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(JACK..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(JACK..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(JACK..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(JACK..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(JACK..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(JACK..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(JACK..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif Text== "جاك" or Text== "الناس عم" then return  sendMsg(msg.chat_id_,msg.id_,"[ملك التلجرام ⚶](https://t.me/V_P_E)")
elseif Text== "خالد" or Text== "جاك" then return  sendMsg(msg.chat_id_,msg.id_,"[ملك التلجرام ⚶](https://t.me/V_P_E)")
elseif Text== "جوكر" or Text== "حبيب الكل وربي" then return  sendMsg(msg.chat_id_,msg.id_,"[ملك التلجرام ⚶](https://t.me/A_j_o_k_e_r)")
...
elseif Text== "اوامر التسليه"  then return sendMsg(msg.chat_id_,msg.id_,"\n‌‌‏ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬\nٴ𐄬 مرحباً عزيزي\nٴ𐄬 هذي اوامر التسليه:  \nٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬\nٴ𐄬 رفع › تنزيل ❬ متوحد ❭\nٴ𐄬 رفع › تنزيل ❬ وتكه ❭\nٴ𐄬 رفع › تنزيل ❬ غبي ❭\nٴ𐄬 رفع › تنزيل ❬ كلب ❭\nٴ𐄬 رفع › تنزيل ❬ حمار ❭\nٴ𐄬 رفع › تنزيل ❬ زوجتي ❭\nٴ𐄬 رفع › تنزيل ❬ متوحده ❭\nٴ𐄬 رفع › ❬ بقلبي ❭ تنزيل › ❬ من قلبي❭\nٴ𐄬 ❬ طلاق ❭ › ❬ زواج ❭\nٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬")
 ...
 elseif Text== "ايديي" or Text=="ايدي ☆" then 
  ...
  elseif Text=="ابي رابط الحذف" or Text=="ابي رابط حذف" or Text=="رابط حذف" or Text=="رابط الحذف" or Text=="رابط هكر" then
  return sendMsg(msg.chat_id_,msg.id_,[[
...
❆رابط حذف [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
  ...
  --=====================================
  elseif Text== "جاك" or Text== "جاك" or Text=="خالد" then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس.](https://t.me/V_P_E) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس.](https://t.me/V_P_E")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس.](https://t.me/A_j_o_k_e_r")
...
if not redis:get('kar') then
  ...
  local creators = redis:smembers(JACK..':MONSHA_BOT:'..GroupS)
  if #creators ~= 0 then
  ...
  local creator = redis:smembers(JACK..':KARA_BOT:'..GroupS)
  if #creator ~= 0 then
