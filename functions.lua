...
─────▀██▀─────
│JACK ‿ @V_P_E
تم تطوير وبرمجة السورس من قبل جاك و الجوكر ☆
│@V_P_E  🖤 JACK 🖤  
 @A_j_o_k_e_r     الجوكر
-------------------------------------------------------------------
]]
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(JACK..":NameBot:")
...
var = 'مطور البوت' 
elseif redis:sismember(JACK..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(JACK..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
...
local monsha = redis:smembers(JACK..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(JACK..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(JACK..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(JACK..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(JACK..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
redis:hset(JACK..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(JACK..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(JACK..'group:add'..msg.chat_id_) then  return '⚶ ↯ المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(JACK..":ismember:"..msg.sender_user_id_,1500,true)
...
local lock_service = redis:get(JACK..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(JACK..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(JACK..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
JACK..'group:add'..msg.chat_id_,true,
JACK..'lock_link'..msg.chat_id_,true, 
JACK..'lock_id'..msg.chat_id_,true,
JACK..'lock_spam'..msg.chat_id_,true,
JACK..'lock_webpage'..msg.chat_id_,true,
JACK..'lock_markdown'..msg.chat_id_,true,
JACK..'lock_flood'..msg.chat_id_,true,
JACK..'lock_bots'..msg.chat_id_,true,
JACK..'mute_forward'..msg.chat_id_,true,
JACK..'mute_contact'..msg.chat_id_,true,
JACK..'mute_location'..msg.chat_id_,true,
JACK..'mute_document'..msg.chat_id_,true,
JACK..'mute_keyboard'..msg.chat_id_,true,
JACK..'mute_game'..msg.chat_id_,true,
JACK..'mute_inline'..msg.chat_id_,true,
JACK..'lock_username'..msg.chat_id_,true,
JACK..'num_msg_JACK'..msg.chat_id_,5, 
JACK..'replay'..msg.chat_id_,true
)

redis:sadd(JACK..'group:ids',msg.chat_id_) 
redis:sadd(JACK..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(JACK..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(JACK..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(JACK..'group:add'..msg.chat_id_) then return '↯  المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(JACK..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⚶ العضو » ❪ '..USERNAME..' ❫\n⚶ الايدي » ❪ '..UserID..' ❫\n⚶ انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(JACK..'username:'..UserID,'username',Resolv)
redis:sadd(JACK..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⚶ العضو » ❪ '..USERNAME..' ❫\n⚶ الايدي » ❪ '..UserID..' ❫\n⚶ تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(JACK..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'⚶ العضو » ❪ '..USERNAME..' ❫\n⚶ الايدي » ❪ '..UserID..' ❫\n⚶ انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(JACK..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(JACK..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⚶ العضو » ❪ '..USERNAME..' ❫\n⚶ الايدي » ❪ '..UserID..' ❫\n⚶ انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(JACK..'username:'..UserID,'username',Resolv)
redis:sadd(JACK..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⚶ العضو » ❪ '..USERNAME..' ❫\n⚶ الايدي » ❪ '..UserID..' ❫\n⚶ تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(JACK..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'⚶ العضو » ❪ '..USERNAME..' ❫\n⚶ الايدي » ❪ '..UserID..' ❫\n⚶ انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(JACK..':KARA_BOT:'..ChatID,UserID)
...
return sendMsg(ChatID,MsgID,"⚶ ↯ لا يمكنك حظر مطور السورس\n") 
elseif UserID == 1396483570 then 
return sendMsg(ChatID,MsgID,"⚶ ↯ لا يمكنك حظر ا\n") 
elseif redis:sismember(JACK..':SUDO_BOT:',UserID) then 
...
if cmd == "unban" then
if not redis:sismember(JACK..'banned:'..ChatID,UserID) then 
...
if redis:sismember(JACK..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⚶ العضو » ❪ '..USERNAME..' ❫\n⚶ الايدي » ❪ '..UserID..' ❫\n⚶ تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(JACK..'username:'..UserID, 'username', Resolv)
...
if not redis:sismember(JACK..'is_silent_users:'..ChatID,UserID) then 
...
return sendMsg(ChatID,MsgID,"⚶ ↯ لا يمكنك طرد مطور السورس\n") 
elseif UserID == 1396483570 then 
return sendMsg(ChatID,MsgID,"⚶ ↯ لا يمكنك طرد ا\n") 
elseif redis:sismember(JACK..':SUDO_BOT:',UserID) then 
...
elseif UserID == 1317966118 then 
return sendMsg(ChatID,MsgID,"⚶ ↯ لا يمكنك تقييد ا\n") 
elseif UserID == 1396483570 then 
return sendMsg(ChatID,MsgID,"⚶ ↯ لا يمكنك تقييد مطور السورس\n") 
elseif redis:sismember(JACK..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"⚶ ↯ لا يمكنك تقييد المطور\n") 
...
if redis:sismember(JACK..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'⚶ ↯ العضو » ❪ '..UserName..' ❫\n⚶ ↯ الايدي » ❪ `'..UserID..'` ❫\n⚶ ↯ تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"⚶ ↯ لا يمكنك طرد المطور\n") 
elseif
redis:sismember(JACK..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⚶ ↯ لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(JACK..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⚶ ↯ لا يمكنك طرد المدير\n") 
elseif redis:sismember(JACK..'admins:'..ChatID,UserID) then 
...
if cmd == "dn_sudo" then
if not redis:sismember(JACK..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'⚶ ↯ العضو » '..USERNAME..' \n⚶ ↯  الايدي » (`'..UserID..'`)\n⚶ ↯ انه بالتأكيد ليس مطور \n') end
redis:srem(JACK..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'⚶ العضو » ❪ '..USERNAME..' ❫\n⚶ الايدي » ❪ '..UserID..' ❫\n⚶ تم تنزيله من المطور \n',17,USERCAR) 
end
...
return sendMsg(ChatID,MsgID,"⚶ ↯ لا يمكنك كتم مطور السورس\n") 
elseif UserID == 1396483570 then 
return sendMsg(ChatID,MsgID,"⚶ ↯ لا يمكنك كتم ا\n") 
elseif redis:sismember(JACK..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"⚶ ↯ لا يمكنك كتم المطور\n") 
elseif redis:sismember(JACK..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⚶ ↯ لا يمكنك كتم المنشئ\n") 
...
if redis:get(JACK..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(JACK..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(JACK..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(JACK..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
...
.."\n⚶ التاك «» "..(redis:get(JACK..'lock_tag'..msg.chat_id_) or 'false')
...
.."\n⚶ الماركدوان «» "..(redis:get(JACK..'lock_markdown'..msg.chat_id_) or 'false')
.."\n⚶ بالطرد البوتات «» "..(redis:get(JACK..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n⚶ البوتات «» "..(redis:get(JACK..'lock_bots'..msg.chat_id_) or 'false')
.."\n⚶ عدد التكرار «» "..(redis:get(JACK..'num_msg_JACK'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⚶`اعدادات الوسائط :`\n"
.."\n*⚶ *المتحركه «» "..(redis:get(JACK..'mute_gif'..msg.chat_id_) or 'false')
.."\n⚶ الدردشه «» "..(redis:get(JACK..'mute_text'..msg.chat_id_) or 'false')
.."\n⚶ الانلاين «» "..(redis:get(JACK..'mute_inline'..msg.chat_id_) or 'false')
...
.."\n⚶ البصمات «» "..(redis:get(JACK..'mute_audio'..msg.chat_id_) or 'false')
.."\n⚶ الصوت «» "..(redis:get(JACK..'mute_voice'..msg.chat_id_) or 'false')
